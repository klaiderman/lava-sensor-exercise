...
- Storage: 2x Micron 7450 PRO NVMe; nvme0n1 = EFI + ext4 root; nvme1n1 has no partition table/filesystem signature known to udev (unused as far as the kernel can tell); no dm/LVM/LUKS/md/multipath/network storage; SMART needs root.
