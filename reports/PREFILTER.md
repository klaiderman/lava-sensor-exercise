...
Run: 2026-09-09T06:05:42Z · module: sensor/ · Hydra pinned e56edc52 (regex single-line prefilter per its README; capped at 2000 lines / 10 findings per file) · Staticcheck staticcheck.exe 2026.1 (v0.7.0)

| tool | rc | output lines | notes |
|---|---|---|---|
| staticcheck ./... (GOOS=linux) | 0 | 0 | rc 0 = no findings |
| go vet ./... (GOOS=linux) | 0 | 0 | |
| hydra vuln-scanner.py per file | files=47 errors=0 | 8528 | finding-shaped lines: 0
0 |
